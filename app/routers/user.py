...
async def create_user(
    ...
    stmt = select(User).where(
        or_(
            User.id == user_in.id,
            User.kakao_id == user_in.kakao_id,
            User.app_user_id == user_in.app_user_id,
            User.plusfriend_user_key == user_in.plusfriend_user_key,
        )
    )
    ...
    if existing_user:
        raise HTTPException(
            ...
            detail="User with this id or kakao_id or app_user_id or plusfriend_user_key already exists",
        )
